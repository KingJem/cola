...
# set DUPEFILTER_CLASS to 'cola.redis_dupefilter.RedisRFPDupeFilter' to enable.
...
# 调度器实现;分布式模式设为 'cola.distributed.scheduler.RedisScheduler'
SCHEDULER_CLASS = 'cola.core.scheduler.Scheduler'
...
#   ['cola.datasources.mysql_source.MySQLSeedProvider']
SEED_SOURCES = []
