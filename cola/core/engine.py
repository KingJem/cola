...
from cola import Request, Item
from cola.core.downloader import DownloaderBase
from cola.core.scheduler import Scheduler
from cola.event import spider_opened, spider_error, request_scheduled
from cola.exceptions import OutputError
from cola.spider import Spider
from cola.utils.spider import transform
from cola.task_manager import TaskManager
from cola.core.processor import Processor
from cola.utils.log import get_logger
from cola.utils.project import load_class
...
class Engine:
    ...
    def engine_start(self):
        self.running = True
        self.logger.info(
            f"cola(version: {self.settings.get('VERSION')}) started. "
