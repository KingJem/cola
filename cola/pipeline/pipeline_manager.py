...
from cola.event import item_successful, item_discard
from cola.exceptions import PipelineInitError, ItemDiscard, InvalidOutput
from cola.utils.log import get_logger
from cola.utils.project import load_class, common_call
