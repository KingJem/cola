...
HOT_CONFIG_EXTENSION = 'cola.extension.hot_config.HotConfig'
STATS_EXPORTER_EXTENSION = 'cola.extension.stats_exporter.StatsExporter'
LOG_STATS_EXTENSION = 'cola.extension.log_stats.LogStats'
...
class Crawler:
    ...
    async def crawl(self):
        ...
        if hasattr(self.spider, 'custom_settings'):
            ...
            from cola.settings.settings_manager import PRIORITY_SPIDER
    ...
    def _load_extensions(self):
        ...
        from cola.extension import ExtensionManager
